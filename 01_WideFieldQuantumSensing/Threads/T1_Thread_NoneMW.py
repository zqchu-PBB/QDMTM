...
class T1_thread(QtCore.QThread):
    ...
    def __init__(self, Info = [], loops = 1, save_path = [], ROI = [], Init = []):
        ...
        self.AOM_Voltage = Info[8]
        self.AOM_Current = Info[9]
        self.loops = loops
                ...
                for t in self.delay_duration_sweeping: # t is the delay time
                    for i in range(2):
                        ...
                        if i == 0: # from the ms = 0 state, without MW
                            ...
                            laser_seq = [(self.AOM_duration, 0),(self.gap_1 + self.MW_duration + self.gap_2 + t, 0)]
                            MW_seq = [(self.AOM_duration + self.gap_1, 0),(self.MW_duration, 0), (self.gap_2 + t, 0)]
